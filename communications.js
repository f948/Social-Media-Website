...
var i,j,k,l,m,pointsAwarded,webPageId=0,nameWithoutExtension,splitNameWithoutExtension=[],numPoints,webpagesSent=0,webPageDate,currentUsername,usernameValue;
						...
						if(alreadyPushed.includes(titleIndex[i].index[k][0].id)){
							...
							for(m=0;m<=webpageData.length-1;m++){
								...
								if(titleIndex[i].index[k][0].id == webpageData[m].id){
									...
									webpageData[m].points+=titleIndex[i].index[k][1]+1;
									break;
							...
							webpageData.push({webpage:titleIndex[i].index[k][0],id:titleIndex[i].index[k][0].id,points:titleIndex[i].index[k][1]+1});
						...
						if(alreadyPushed.includes(descriptionIndex[i].index[k][0].id)){
							...
							for(m=0;m<=webpageData.length-1;m++){
								...
								if(descriptionIndex[i].index[k][0].id == webpageData[m].id){
									...
									webpageData[m].points+=descriptionIndex[i].index[k][1]+1;
									break;
							...
							webpageData.push({webpage:descriptionIndex[i].index[k][0],id:descriptionIndex[i].index[k][0].id,points:descriptionIndex[i].index[k][1]+1});
