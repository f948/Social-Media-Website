			...
			for(j=0;j<=distinctKeyword.length-1;j++){
				...
				if(titleIndex[i].word == distinctKeyword[j]){
					...
					for(k=0;k<=titleIndex[i].index.length-1;k++){
						...
						if(titleIndex[i].index[k][1] > 0){
					
							if(alreadyPushed.includes(titleIndex[i].index[k][0].id)){
							
								for(m=0;m<=listOfWebpages.length-1;m++){
								
									if(titleIndex[i].index[k][0].id == listOfWebpages[m].webpage.id){
									
										if(titleIndex[i].index[k][1] <= 9){
											listOfWebpages[m].points+=10-titleIndex[i].index[k][1];
										}
							...
							else if(!alreadyPushed.includes(titleIndex[i].index[k][0].id) && titleIndex[i].index[k][1] > 0){
							
								if(titleIndex[i].index[k][1] <= 9){
									listOfWebpages.push({webpage:titleIndex[i].index[k][0],points:10-titleIndex[i].index[k][1],count:1});
								}
							
								else if(titleIndex[i].index[k][1] > 9){
									listOfWebpages.push({webpage:titleIndex[i].index[k][0],points:0,count:1});
								}
			...
			for(j=0;j<=distinctKeyword.length-1;j++){
				...
				if(descriptionIndex[i].word == distinctKeyword[j]){
					...
					for(k=0;k<=descriptionIndex[i].index.length-1;k++){
						...
						if(descriptionIndex[i].index[k][1] > 0){
							
							if(alreadyPushed.includes(descriptionIndex[i].index[k][0].id)){
							
								for(m=0;m<=listOfWebpages.length-1;m++){
								
									if(descriptionIndex[i].index[k][0].id == listOfWebpages[m].webpage.id){
									
										if(descriptionIndex[i].index[k][1] <= 9){
											listOfWebpages[m].points+=10-descriptionIndex[i].index[k][1];
										}
							...
							else if(!alreadyPushed.includes(descriptionIndex[i].index[k][0].id) && descriptionIndex[i].index[k][1] > 0){
							
								if(descriptionIndex[i].index[k][1] <= 9){
									listOfWebpages.push({webpage:descriptionIndex[i].index[k][0],points:10-descriptionIndex[i].index[k][1],count:1});
								}
							
								else if(descriptionIndex[i].index[k][1] > 9){
									listOfWebpages.push({webpage:descriptionIndex[i].index[k][0],points:0,count:1});
								}
