...
var i,j,k,pointsAwarded,webPageId=0,connectedUsers=0,nameWithoutExtension,splitNameWithoutExtension=[],numPoints;
...
io.on('connection', function(socket) {
	...
	socket.on("sendWebPage",function(data){
			...
			webPages.push({username:data.username,image:data.image,name:data.name,code:data.code,message:data.message,comments:"",date:data.date,id:webPageId,deleted:false});
			io.sockets.emit("getWebPage",{username:data.username,image:data.image,name:data.name,code:data.code,message:data.message,comments:"",date:data.date,id:webPageId,deleted:false});
			webPageId++;
