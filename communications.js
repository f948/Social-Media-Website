							...
							if(alreadyPushed.includes(titleIndex[i].index[k][0].id)){
								...
								for(m=0;m<=listOfWebpages.length-1;m++){
									...
									if(titleIndex[i].index[k][0].id == listOfWebpages[m].webpage.id){
										...
										listOfWebpages[m].points+=100-titleIndex[i].index[k][1];
								...
								listOfWebpages.push({webpage:titleIndex[i].index[k][0],points:100-titleIndex[i].index[k][1],count:1});
							...
							if(alreadyPushed.includes(descriptionIndex[i].index[k][0].id)){
								...
								for(m=0;m<=listOfWebpages.length-1;m++){
									...
									if(descriptionIndex[i].index[k][0].id == listOfWebpages[m].webpage.id){
										...
										listOfWebpages[m].points+=2500-descriptionIndex[i].index[k][1];
										listOfWebpages[m].count++;
										break;
								...
								listOfWebpages.push({webpage:descriptionIndex[i].index[k][0],points:2500-descriptionIndex[i].index[k][1],count:1});
